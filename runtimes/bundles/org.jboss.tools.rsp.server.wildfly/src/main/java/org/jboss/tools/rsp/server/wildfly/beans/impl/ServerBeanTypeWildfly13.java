...
public class ServerBeanTypeWildfly13 extends JBossServerBeanType {
	public ServerBeanTypeWildfly13() {
	...
	public String getFullVersion(File location, File systemFile) {
		return ServerBeanTypeWildfly90.getFullVersion(location, systemFile, "13.");
	}
	...
	public String getServerAdapterTypeId(String version) {	
		return IServerConstants.SERVER_WILDFLY_130;
	}
}
