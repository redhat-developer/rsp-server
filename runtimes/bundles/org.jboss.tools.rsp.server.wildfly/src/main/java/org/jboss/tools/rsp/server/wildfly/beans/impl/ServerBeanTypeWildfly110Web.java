...
public class ServerBeanTypeWildfly110Web extends JBossServerBeanType {
	...
	public String getFullVersion(File location, File systemFile) {
		return ServerBeanTypeWildfly90Web.getFullVersion(location, systemFile, "11.");
	}
	...
	public String getServerAdapterTypeId(String version) {	
		return IServerConstants.SERVER_WILDFLY_110;
	}
}
