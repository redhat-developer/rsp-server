...
public class ServerBeanTypeWildfly90Web extends JBossServerBeanType {
	public ServerBeanTypeWildfly90Web() {
		super(ID_WILDFLY_WEB, NAME_WILDFLY, AS7_MODULE_LAYERED_SERVER_MAIN);
	}
	...
	public String getFullVersion(File location, File systemFile) {
		return ServerBeanTypeWildfly90Web.getFullVersion(location, systemFile, "9.");
	}
