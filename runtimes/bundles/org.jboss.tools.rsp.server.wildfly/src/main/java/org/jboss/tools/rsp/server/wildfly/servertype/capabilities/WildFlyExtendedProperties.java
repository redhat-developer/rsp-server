...
public class WildFlyExtendedProperties {
	...
	public static class Wildfly200ExtendedProperties extends AbstractWildflyExtendedProperties {
		public Wildfly200ExtendedProperties(IServer server) {
			super("20.0", "1.8", "15.", HTTP_REMOTING_JMX_NEW, new Wildfly110DefaultLaunchArguments(server), server);
		}
	}
	public static class Wildfly210ExtendedProperties extends AbstractWildflyExtendedProperties {
		public Wildfly210ExtendedProperties(IServer server) {
			super("21.0", "1.8", "15.", HTTP_REMOTING_JMX_NEW, new Wildfly110DefaultLaunchArguments(server), server);
		}
	}
	public static class Wildfly220ExtendedProperties extends AbstractWildflyExtendedProperties {
		public Wildfly220ExtendedProperties(IServer server) {
			super("22.0", "1.8", "15.", HTTP_REMOTING_JMX_NEW, new Wildfly110DefaultLaunchArguments(server), server);
		}
	}
	public static class Wildfly230ExtendedProperties extends AbstractWildflyExtendedProperties {
		public Wildfly230ExtendedProperties(IServer server) {
			super("23.0", "1.8", "15.", HTTP_REMOTING_JMX_NEW, new Wildfly110DefaultLaunchArguments(server), server);
		}
	}
	public static class Wildfly240ExtendedProperties extends AbstractWildflyExtendedProperties {
		public Wildfly240ExtendedProperties(IServer server) {
			super("24.0", "1.8", "15.", HTTP_REMOTING_JMX_NEW, new Wildfly110DefaultLaunchArguments(server), server);
		}
	}
	// NEW_SERVER_ADAPTER 
}
