...
public interface IServerConstants {
	...
	public static final String SERVER_EAP_XP = "org.jboss.ide.eclipse.as.xp.standalone"; //$NON-NLS-1$
	...
	public static final Map<String, String> RUNTIME_TO_SERVER = createRuntimeToServerMap();

	static Map<String, String> createRuntimeToServerMap() {
	    Map<String,String> myMap = new HashMap<String,String>();
	    myMap.put(RUNTIME_AS_32, SERVER_AS_32);
	    myMap.put(RUNTIME_AS_40, SERVER_AS_40);
	    myMap.put(RUNTIME_AS_42, SERVER_AS_42);
	    myMap.put(RUNTIME_AS_50, SERVER_AS_50);
	    myMap.put(RUNTIME_AS_51, SERVER_AS_51);
	    myMap.put(RUNTIME_AS_60, SERVER_AS_60);
	    myMap.put(RUNTIME_AS_70, SERVER_AS_70);
	    myMap.put(RUNTIME_AS_71, SERVER_AS_71);
	    myMap.put(RUNTIME_WILDFLY_80, SERVER_WILDFLY_80);
	    myMap.put(RUNTIME_WILDFLY_90, SERVER_WILDFLY_90);
	    myMap.put(RUNTIME_WILDFLY_100, SERVER_WILDFLY_100);
	    myMap.put(RUNTIME_WILDFLY_110, SERVER_WILDFLY_110);
		myMap.put(RUNTIME_WILDFLY_120, SERVER_WILDFLY_120);
		myMap.put(RUNTIME_WILDFLY_130, SERVER_WILDFLY_130);
		myMap.put(RUNTIME_WILDFLY_140, SERVER_WILDFLY_140);
		myMap.put(RUNTIME_WILDFLY_150, SERVER_WILDFLY_150);
		myMap.put(RUNTIME_WILDFLY_160, SERVER_WILDFLY_160);
		myMap.put(RUNTIME_WILDFLY_170, SERVER_WILDFLY_170);
		myMap.put(RUNTIME_WILDFLY_180, SERVER_WILDFLY_180);
		myMap.put(RUNTIME_WILDFLY_190, SERVER_WILDFLY_190);
		myMap.put(RUNTIME_WILDFLY_200, SERVER_WILDFLY_200);
		myMap.put(RUNTIME_WILDFLY_210, SERVER_WILDFLY_210);
		myMap.put(RUNTIME_WILDFLY_220, SERVER_WILDFLY_220);
		...
		myMap.put(RUNTIME_EAP_61, SERVER_EAP_61);
		myMap.put(RUNTIME_EAP_70, SERVER_EAP_70);
		myMap.put(RUNTIME_EAP_71, SERVER_EAP_71);
		myMap.put(RUNTIME_EAP_72, SERVER_EAP_72);
		myMap.put(RUNTIME_EAP_73, SERVER_EAP_73);
		myMap.put(RUNTIME_EAP_74, SERVER_EAP_74);
		myMap.put(RUNTIME_EAP_80, SERVER_EAP_80);
		// NEW_SERVER_ADAPTER
	    return myMap;
	}
