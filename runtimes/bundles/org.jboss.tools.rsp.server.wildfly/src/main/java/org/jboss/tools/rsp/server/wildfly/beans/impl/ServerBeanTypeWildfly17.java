...
public class ServerBeanTypeWildfly17 extends JBossServerBeanType {
	public ServerBeanTypeWildfly17() {
	...
	public String getFullVersion(File location, File systemFile) {
		return ServerBeanTypeWildfly90.getFullVersion(location, systemFile, "17.");
	}
