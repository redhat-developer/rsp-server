...
public class ServerBeanTypeWildfly16 extends JBossServerBeanType {
	public ServerBeanTypeWildfly16() {
	...
	public String getFullVersion(File location, File systemFile) {
		return ServerBeanTypeWildfly90.getFullVersion(location, systemFile, "16.");
	}
