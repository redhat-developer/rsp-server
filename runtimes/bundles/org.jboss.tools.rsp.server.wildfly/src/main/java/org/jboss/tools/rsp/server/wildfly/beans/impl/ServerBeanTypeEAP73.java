...
public class ServerBeanTypeEAP73 extends ServerBeanTypeEnterprise {
	...
	public String getServerAdapterTypeId(String version) {
		return IServerConstants.SERVER_EAP_73;
	}
	public boolean isServerRoot(File location) {
		return getEAP6xVersion(location, EAP_LAYERED_PRODUCT_META_INF, "7.3", "eap", RELEASE_NAME_JBOSS_EAP) != null; //$NON-NLS-1$
	}
	public String getFullVersion(File location, File systemJarFile) {
		return getEAP6xVersion(location, EAP_LAYERED_PRODUCT_META_INF, "7.3", "eap", RELEASE_NAME_JBOSS_EAP); //$NON-NLS-1$
	}
}
