...
public class ExtendedServerPropertiesAdapterFactory implements IServerConstants {
	...
	public ServerExtendedProperties getExtendedProperties(IServer s) {
		...
		case SERVER_EAP_74:
			return new JBossEAP74ExtendedProperties(s);
		case SERVER_EAP_80:
			return new JBossEAP80ExtendedProperties(s);
		...
		case SERVER_WILDFLY_230:
			return new Wildfly230ExtendedProperties(s);
		case SERVER_WILDFLY_240:
