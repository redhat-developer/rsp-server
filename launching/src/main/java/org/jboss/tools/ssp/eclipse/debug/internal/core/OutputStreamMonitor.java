 ...
 *******************************************************************************/
package org.jboss.tools.ssp.eclipse.debug.internal.core;
...
import org.jboss.tools.ssp.eclipse.core.runtime.ISafeRunnable;
import org.jboss.tools.ssp.eclipse.core.runtime.ListenerList;
...
public class OutputStreamMonitor implements IFlushableStreamMonitor {
	...
	/**
	 * @see org.jboss.tools.ssp.eclipse.debug.core.model.IFlushableStreamMonitor#setBuffered(boolean)
	 */
	@Override
	...
	/**
	 * @see org.jboss.tools.ssp.eclipse.debug.core.model.IFlushableStreamMonitor#flushContents()
	 */
	@Override
	...
	class ContentNotifier implements ISafeRunnable {
		...
		/**
		 * @see org.jboss.tools.ssp.eclipse.core.runtime.ISafeRunnable#handleException(java.lang.Throwable)
		 */
		@Override
		...
		/**
		 * @see org.jboss.tools.ssp.eclipse.core.runtime.ISafeRunnable#run()
		 */
		@Override
