...
public class ServerBeanTypeEAP71 extends ServerBeanTypeEnterprise {
	...
	public boolean isServerRoot(File location) {
		return getEAP6xVersion(location, EAP_LAYERED_PRODUCT_META_INF, "7.", "eap", RELEASE_NAME_JBOSS_EAP) != null; //$NON-NLS-1$
	}
	public String getFullVersion(File location, File systemJarFile) {
		return getEAP6xVersion(location, EAP_LAYERED_PRODUCT_META_INF, "7.", "eap", RELEASE_NAME_JBOSS_EAP); //$NON-NLS-1$
	}
}
